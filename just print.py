...
# ===============================================================
# [사용자 설정 영역] 아래 내용을 본인에 맞게 수정하세요.
# ===============================================================

# 1. 공공데이터포털 인증키 (보내주신 키 적용됨)
# 만약 실행 시 SERVICE_KEY_IS_NOT_REGISTERED_ERROR 같은 에러가 난다면,
# 포털에서 '일반 인증키(Decoding)' 값을 다시 확인해보세요.
API_KEY = "004c7c516b0263e5aa95f9db6df5bd47bb556e57e61248e3f127a8fb0e9fffbd"

# 2. 종관기상관측 지점 번호 (본인이 선호하는 지역 번호 선택)
# 예: 서울(108), 부산(159), 대전(133), 광주(156), 대구(143)
STN_ID = "108"

# 3. 과제 제출일 (이 날짜를 기준으로 '이틀 전'을 계산합니다)
# 형식: "YYYYMMDD" (예: 2025년 11월 20일 제출이면 "20251120")
...
# ===============================================================
# [메인 실행 로직] 문제에서 요구한 3가지 기간에 대해 실행
# ===============================================================
